...
env.read_env()
try: 
    username = env.str("TW_MINER_USERNAME")
except EnvError as e: 
    print("Missing Username Environment variable for TW_MINE_USERNAME.  This is a fatal error and we will quit.")
    failed = True

try: 
    channels = env.list("TW_MINER_CHANNELS")
except EnvError as e: 
    print("Missing Username Environment variable for TW_MINE_CHANNELS.  This is a fatal error and we will quit.")
    failed = True

try: 
    password = env.str("TW_MINER_PASSWORD")
except EnvError as e: 
    print("Missing Username Environment variable for TW_MINE_PASSWORD.  Password will be requested interactively if auth token is not cached.")
    password=""
...
twitch_miner = TwitchChannelPointsMiner(
    username=username,
    password=password if password else None ,           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        time_zone="Australia/Melbourne",        # Set a specific time zone for console and file loggers. Use tz database names. Example: "America/Denver"
...
print(channels)
twitch_miner.mine(
    [ Streamer(channel) for channel in channels ],
